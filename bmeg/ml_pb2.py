...
_SIGNATURETRAINING_COEFFICIENTSENTRY = _descriptor.Descriptor(
  ...
  full_name='bmeg.ml.SignatureTraining.CoefficientsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='bmeg.ml.SignatureTraining.CoefficientsEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='bmeg.ml.SignatureTraining.CoefficientsEntry.value', index=1,
...
_SIGNATURETRAINING_BACKGROUNDENTRY = _descriptor.Descriptor(
  ...
  full_name='bmeg.ml.SignatureTraining.BackgroundEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='bmeg.ml.SignatureTraining.BackgroundEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='bmeg.ml.SignatureTraining.BackgroundEntry.value', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SIGNATURETRAINING = _descriptor.Descriptor(
  ...
  full_name='bmeg.ml.SignatureTraining',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='bmeg.ml.SignatureTraining.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='gid', full_name='bmeg.ml.SignatureTraining.gid', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='bmeg.ml.SignatureTraining.type', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='predicts', full_name='bmeg.ml.SignatureTraining.predicts', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='phenotype', full_name='bmeg.ml.SignatureTraining.phenotype', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quantile', full_name='bmeg.ml.SignatureTraining.quantile', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='intercept', full_name='bmeg.ml.SignatureTraining.intercept', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='coefficients', full_name='bmeg.ml.SignatureTraining.coefficients', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='background', full_name='bmeg.ml.SignatureTraining.background', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='backgroundCohort', full_name='bmeg.ml.SignatureTraining.backgroundCohort', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signatureFor', full_name='bmeg.ml.SignatureTraining.signatureFor', index=10,
...
_SIGNATUREEXPRESSIONEDGE = _descriptor.Descriptor(
  ...
  full_name='bmeg.ml.SignatureExpressionEdge',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='bmeg.ml.SignatureExpressionEdge.type', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='in', full_name='bmeg.ml.SignatureExpressionEdge.in', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='out', full_name='bmeg.ml.SignatureExpressionEdge.out', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='level', full_name='bmeg.ml.SignatureExpressionEdge.level', index=3,
...
SignatureTraining = _reflection.GeneratedProtocolMessageType('SignatureTraining', (_message.Message,), dict(
  ...
  CoefficientsEntry = _reflection.GeneratedProtocolMessageType('CoefficientsEntry', (_message.Message,), dict(
    ...
    __module__ = 'ml_pb2'
    # @@protoc_insertion_point(class_scope:bmeg.ml.SignatureTraining.CoefficientsEntry)
    ))
  ,
  ...
  BackgroundEntry = _reflection.GeneratedProtocolMessageType('BackgroundEntry', (_message.Message,), dict(
    ...
    __module__ = 'ml_pb2'
    # @@protoc_insertion_point(class_scope:bmeg.ml.SignatureTraining.BackgroundEntry)
    ))
  ,
  DESCRIPTOR = _SIGNATURETRAINING,
  __module__ = 'ml_pb2'
  # @@protoc_insertion_point(class_scope:bmeg.ml.SignatureTraining)
  ))
...
SignatureExpressionEdge = _reflection.GeneratedProtocolMessageType('SignatureExpressionEdge', (_message.Message,), dict(
  ...
  __module__ = 'ml_pb2'
  # @@protoc_insertion_point(class_scope:bmeg.ml.SignatureExpressionEdge)
  ))
_sym_db.RegisterMessage(SignatureExpressionEdge)


_SIGNATURETRAINING_COEFFICIENTSENTRY.has_options = True
_SIGNATURETRAINING_COEFFICIENTSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_SIGNATURETRAINING_BACKGROUNDENTRY.has_options = True
_SIGNATURETRAINING_BACKGROUNDENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
